...
//	$("#solution").html(jsondata.solution);
	...
	if(jsondata.eventtype == '06'){
		var rs = '<tr><th width="15%"><span>第三方施工项目名称</span></th>\
			<td width="85%" colspan="3"><span id="constructionid"></span></td></tr>';
		$('#constructionTr1').after(rs);
		$("#constructionid").html(jsondata.constructionidname);
	}else{
		/*var rs = '<tr><td width="15%"></td><td width="85%" colspan="3"></td><tr/>';
		$('#constructionTr1').after(rs);*/
	}
}
