...
$(document).ready(function(){
	...
	$('#uploadingStaff').val(user.userName);
...
function saveBaseInfo(){
	...
	if(isNull(businessId)){
		bID = saveGpsSecurityStandard();  // sava()保存基本信息函数，返回业务id
	}else{
		bID = businessId;
	}
	return bID;
 ...
 * @desc 添加数据-保存
 */
function saveGpsSecurityStandard(){
	...
	$.ajax({
		url : rootPath+"/gpssecuritystandard/save.do",
		type: "post",
		async: false,
 ...
 */
function closePanel() {
	top. closeDlg("addGpsSecurityStandard");
}
