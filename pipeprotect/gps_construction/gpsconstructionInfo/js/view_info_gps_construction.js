...
$(document).ready(function() {
	$('#gps_project_progress_iframe').attr('src',"project_progress/query_project_progress_construction.html?oid="+pkfield);
...
function loadChangeData(jsondata){
	...
	for(var i=0; i<jsondata.length; i++){
		rs += '<div class="table-content"><h6 class="table-title">第'+j+'次风险等级变更</h6>'
			...
			+ '<tr><th width="15%"><span>变更发起人</span></th><td width="35%" colspan="3"><span>'+jsondata[i].changeuseridname+'</span></td></tr>';
...
function loadData(jsondata){
	...
	$("#riskratingrealCodeName").html(jsondata.riskratingrealCodeName);
