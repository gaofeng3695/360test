...

		  	{
		  		...
		  		formatter: function(value,row,index){
					var opt = '<p class="table-operate"><a href="#" title = "查看" onclick="view(\'' + row.oid+'\')">\
		  			...
		  			var opt = '<p class="table-operate"><a class = "a10060101" href="#" title = "查看" onclick="view(\'' + row.oid+'\')">\
 ...
 */
function doInstask(){
	showLoadingMessage("正在生成巡线工巡检任务，请稍候。。。");
	$.ajax({
	   url: rootPath+"/gpsinstaskday/doInstaskNew.do",
