		...
		[[
...

	    	{
	    	...
	    	}/*,
		  	{
		  		...
		  		width:$(this).width() * 0.1,
		  		formatter: function(value,row,index){
					var opt = '<p class="table-operate"><a class = "a10050101" href="#" title = "查看" onclick="view(\'' + row.oid+'\')">\
									<span class="fa fa-eye"></span></a>';
					if(row.isPis != '1'){
						opt += '<a class = "a10050103" href="#" title = "修改" onclick="update(\'' + row.oid+'\')">\
									<span class="fa fa-edit"></span></a>\
						   	   <a class = "a10050104" href="#" title = "删除" onclick="dele(\'' + row.oid+'\')">\
