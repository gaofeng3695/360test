...
$(document).ready(function(){
	$('#10020405').menubutton({menu:'#exportBars'});
	$('#gpsInsrangedatagrid').datagrid({
		idField:'oid',
		url: rootPath+"/gpsinsrange/getPage.do?inspectorType=02&sign=02&subsytemeventid="+suboid,
		collapsible:true,
		autoRowHeight: false,
		remoteSort:true,
        /*fitColumns: true,*/
		...
		[[
            ...
            {
                field:"highConsequencesLevelName",
                title:"高后果区等级",
                width:$(this).width() * 0.05,
                resizable:true,
                sortable:true,
            ...
            {
                field:"highConsequencesTypeName",
                title:"高后果区类型",
                width:$(this).width() * 0.05,
                resizable:true,
                sortable:true,
	    	...
	    	/*,
		  	{
		  		...
		  		formatter: function(value,row,index){
					var opt = '<p class="table-operate"><a href="#" class = "a10020401" title = "查看" onclick="view(\'' + row.oid+'\')">\
									<span class="fa fa-eye"></span>\
							   </a><a class = "a10020403" href="#" title = "修改" onclick="update(\'' + row.oid+'\')">\
									<span class="fa fa-edit"></span>\
						   	   </a><a class = "a10020404" href="#" title = "删除" onclick="dele(\'' + row.oid+'\')">\
...
function exportSelect(){
	...
	if(!isNull(idArray)){
		url=addTokenForUrl(rootPath+'/gpsinsrange/exportToExcelAction.do?sign=02&inspectorType=02&oidList='+idArray);
...
function exportQuery(){
	...
	var url =addTokenForUrl(rootPath+'/gpsinsrange/exportToExcelAction.do?sign=02&inspectorType=02&'+$('#queryForm').serialize());
	$("#exprotExcelIframe").attr("src",url);
}
