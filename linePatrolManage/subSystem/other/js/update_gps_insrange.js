...
$(document).ready(function() {
    ...
    $('#insfreq').combobox({
        ...
        editable:true,
        mode:'remote',
        url : rootPath+"jasframework/sysdoman/getDoman.do?domainName=otherdaytime",
        valueField : "codeId",
        textField : "codeName",
...
function initLocaUser( inspectorId , unitId){
    ...
    $('#'+inspectorId).combobox({
        ...
        editable:true,
        mode:'remote',
        url : rootPath+'/xncommon/getInspectorIdSelectByType.do?unitId='+unitId+'&inspectortype=03',
        valueField : "codeid",
        textField : "codename",
...
function loadData(jsondata){
   ...
   /* $.each(totalInput, function( index, item ){
	...
	$('#patrolRole').combobox('setValue',jsondata.patrolRole);
}
