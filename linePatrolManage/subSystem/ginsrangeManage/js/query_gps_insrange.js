...
$(document).ready(function(){
	...
	$('#gpsInsrangedatagrid').datagrid({
		idField:'oid',
		url: rootPath+"/gpsinsrange/getPage.do?inspectorType=02&sign=01&subsytemeventid="+suboid,
		collapsible:true,
		autoRowHeight: false,
		remoteSort:true,
        /*fitColumns: true,*/
...
function exportSelect(){
	...
	if(!isNull(idArray)){
		url=addTokenForUrl(rootPath+'/gpsinsrange/exportToExcelAction.do?sign=01&inspectorType=02&oidList='+idArray);
...
function exportQuery(){
	...
	var url =addTokenForUrl(rootPath+'/gpsinsrange/exportToExcelAction.do?sign=01&inspectorType=02&'+$('#queryForm').serialize());
	$("#exprotExcelIframe").attr("src",url);
}
