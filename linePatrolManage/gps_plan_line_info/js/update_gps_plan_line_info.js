...
var rowIndex = getParamter("rowIndex");
var lineloopoid = getParamter("lineloopoid");
var beginlocation = getParamter("beginlocation");
var endlocation = getParamter("endlocation");
var beginstation = getParamter("beginstation");
var endstation = getParamter("endstation");
...
function updateGpsPlanInfo(){
	...
	updateRow(sendHtml+'.html', JSON.stringify(data));
	enableButtion("saveButton");
	closePanel();
}
