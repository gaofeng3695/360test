...
$(document).ready(function(){
	querySerialize={inspectortype:'01',recordtype:'02'}
 ...
 * @returns
 */
function syncInsrecordError(){
	showLoadingMessage("正在上传巡检异常记录数据，请稍候。。。");
	$.ajax({
		url: rootPath+"/gpsinsrecord/uploadInspectionRecord.do?recordtype=02",
