...
function initPlanInfoData(){
	$('#gpsPlanInfodatagrid').datagrid({
		...
		onDblClickRow:function(index,indexData){
			top.getDlg("../../gps_plan_info/view_gps_plan_info.html?oid="+indexData.pid,"viewGpsPlanInfo","计划详细",1000,600,false,true,true);
		},
...
function initKeyPoingData(){
	$('#gpsKeypointdatagrid').datagrid({
		...
		onDblClickRow:function(index,indexData){
			top.getDlg("../../pathLine/keypoint/view_gps_keypoint.html?oid="+indexData.oid,"viewGpsKeypoint","关键点详细",1000,600,false,true,true);
		},
		onLoadSuccess:function(data){
...
function loadData(jsondata){
	...
	$("#insRangeLength").html(jsondata.insRangeLength);
	$("#bufferwidth").html(jsondata.bufferwidth);
	$("#collectBeginTime").html(jsondata.collectBeginTime);
	$("#collectEndTime").html(jsondata.collectEndTime);
