 ...
 * @author  Lzz
 * @desc 解决几个小问题
 * 	 解决问题1：datagrid单元格内容展示不全的问题
 *         修改行号： 11354
 *         修改行号：11374
 *  解决问题2：common里面datagrid定义的默认执行的onloadSuccess被单个页面的onloadSuccess覆盖的问题
 *  	         修改行号：10181
 *  	        修改行号：
 *  
 * @date  2018-03-14 
...
/*************修改代码开始****************/
 /*
  * @desc 添加onLoadSuccess1事件防止common里的被单个页面的覆盖
  * @author Lzz
  */
 ...
 // 修改后：
 opts.onLoadSuccess1.call(_726,data);
 opts.onLoadSuccess.call(_726,data);
/************修改代码结束***********/
...
/*************修改代码开始****************/
 /*
  * @desc 给单元格添加class="td-overflow-ellipsis"
  * @author Lzz
  */
 ...
 // 修改后：
 cc.push(col.checkbox?"class=\"datagrid-cell-check\"":"class=\"datagrid-cell td-overflow-ellipsis "+col.cellClass+"\"");
/************修改代码结束***********/
cc.push(">");
if(col.checkbox){
...
/*************修改代码开始****************/
 /*
  * @desc 给单元格内嵌一个span添加一个title和class
  * @author Lzz
  */
...
let item = "<span title='" + itemValue + "' class='tip' >" + itemValue + "</span>";
cc.push(item);
/************修改代码结束***********/
}
}
...
/* 修复easyuiBUG */
_867.dc.view.height(_867.dc.view.height() + h);
}
}
