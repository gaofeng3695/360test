...
function exportQuery(){
	...
	if(querySerialize != null){
		url=addTokenForUrl(rootPath+'/gpsinsdaywork/exportToExcelAction.do?inspectorid='+inspectorid+"&unitid="+unitid+"&statisticsdate="+querySerialize.statisticsdate+"&inspectortype="+querySerialize.inspectortype+"&statisticsdatequery="+querySerialize.statisticsdatequery);
