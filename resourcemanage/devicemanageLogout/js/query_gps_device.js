...
$(document).ready(function(){
			...
			{	
		  	...
		  	/*{
		  		...
		  		formatter: function(value,row,index){
                    ...
                    var opt = '<p class="table-operate"><a class = "a11020301" href="#" title = "查看" onclick="view(\'' + row.oid+'\')">\
										<span class="fa fa-eye"></span>\
								   </a></p>';
                    return opt;
				}
	...
	var comboxid='status,approvalStatus,devtype,';
	var singleDomainName='devicestatus,deviceapprovalstatus,devicetype,';	// 单选值域
	var morecomboxid='';
