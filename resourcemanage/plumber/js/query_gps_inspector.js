...
$(document).ready(function(){
	$('#11010206').menubutton({menu:'#exportBars'});
	$('#gpsInspectordatagrid').datagrid({
		idField:'oid',
		url: rootPath+"/gpsinspector/getPage.do?inspectortype=02",
		collapsible:true,
		sortName: 'workStatus',
		sortOrder : 'asc',
		autoRowHeight: false,
		...
		[[
            ...
            },
			{
				...
				formatter: function(value,row,index){
					if( value == null ) {
						return '-';
					} else if (value.indexOf('01') != -1 && value.indexOf('02') != -1) {
						return '段长/区长';
					} else if (value.indexOf('01') != -1) {
						return '段长';
			...
			/*{
		  	...
		  	/*{
		  		...
		  		width:$(this).width() * 0.15,
		  		formatter: function(value,row,index){
		  			var  opt = '<p class="table-operate"><a class = "a11010201" href="#" title = "查看" onclick="view(\'' + row.oid+'\')">\
									<span class="fa fa-eye"></span>\
							   </a><a class = "a11010203" href="#" title = "修改" onclick="update(\'' + row.oid+'\',\''+row.deviceoid+'\',\''+row.deviceoid+'\',\''+row.insname+'\')">\
									<span class="fa fa-edit"></span>\
						   	   </a><a class = "a11010204" href="#" title = "删除" onclick="dele(\'' + row.oid+'\')">\
