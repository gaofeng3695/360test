...
var insOid = getParamter("oid");//管道工id
...
$(document).ready(function(){
	$('#gpsInspectordatagrid').datagrid({
		idField:'oid',
		url: rootPath+"/gpsinspector/getNotBind.do?unitid="+unitid+"&insOid="+insOid,
		collapsible:true,
		autoRowHeight: false,
		remoteSort:true,
        fitColumns: true,
...
//			if (r){
				$.ajax({
				   url: rootPath+"/gpsinspector/saveHasBind.do",
