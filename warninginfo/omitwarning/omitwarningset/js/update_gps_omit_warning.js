...
function updategpsOmitWarning(){
	...
	$.ajax({
		url : rootPath+"/gpsomitwarning/update.do",
		type: "post",
...
function loadData(jsondata){
	...
	$('#daytime').val(jsondata.daytime);
	$('#pointnum').val(jsondata.pointnum);
	/*$('#warncontent').val(jsondata.warncontent);*/
}
 ...
 */
function closePanel() {
	top. closeDlg("updategpsOmitWarning");
}
